 ...
 * @author slintas
 */
public class NewCommentTo extends ModelMVC {
    ...
    public void proccess(HttpServletRequest request, HttpServletResponse response) {
        CommentsTO commentsTO = new CommentsTO(request.getParameter("comment"), 
                ...
                Integer.parseInt(request.getParameter("to_id")));
        
        boolean flag = DAOFactory.getMySQLDAOFactory().getCommentsDAO().commentTo(commentsTO);
